    ...
    <div className="rounded-lg bg-white p-1">
      <div className="flex">
        <div className="flex  border border-gray-200 max-w-fit text-sm mx-3 mt-2">
          <button
            className={`px-3 py-2 hover:bg-blue-100  hover:text-blue-500 cursor-pointer outline-none max-w-fit ${
              timePeriod === "1d" && "text-blue-500 bg-blue-100"
            }`}
            value="1d"
          ...
          <button
            className={`px-3 py-2 hover:bg-blue-100  hover:text-blue-500 cursor-pointer outline-none max-w-fit ${
              timePeriod === "5d" && "text-blue-500 bg-blue-100"
            }`}
            value="5d"
            onClick={handleTimePeriod}
            readOnly
          ...
          <button
            className={`px-3 py-2 hover:bg-blue-100  hover:text-blue-500 cursor-pointer outline-none max-w-fit ${
              timePeriod === "1mo" && "text-blue-500 bg-blue-100"
            }`}
            value="1mo"
            onClick={handleTimePeriod}
            readOnly
          ...
          <button
            className={`px-3 py-2 hover:bg-blue-100  hover:text-blue-500 cursor-pointer outline-none max-w-fit ${
              timePeriod === "6mo" && "text-blue-500 bg-blue-100"
            }`}
            value="6mo"
            onClick={handleTimePeriod}
            readOnly
          ...
          <button
            className={`px-3 py-2 hover:bg-blue-100  hover:text-blue-500 cursor-pointer outline-none max-w-fit ${
              timePeriod === "max" && "text-blue-500 bg-blue-100"
            }`}
            value="max"
            onClick={handleTimePeriod}
            readOnly
        ...
        <div className="flex border border-gray-200 max-w-fit ml-20 mt-2">
          <button
            className={`px-3 py-2 hover:bg-blue-100  hover:text-blue-500 cursor-pointer outline-none max-w-fit ${
              chartType === "line" && "text-blue-500 bg-blue-100"
            }`}
            value="line"
          ...
          <button
            className={`px-3 py-2 hover:bg-blue-100  hover:text-blue-500 cursor-pointer outline-none max-w-fit ${
              chartType === "candle" && "text-blue-500 bg-blue-100"
            }`}
            value="candle"
            onClick={handleChartType}
            readOnly
